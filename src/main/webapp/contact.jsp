<%-- 
    Document   : contact
    Created on : Feb 24, 2024, 2:49:07 PM
    Author     : ASUS
--%>
                    ...
                    <div class="row">
                        ...
                        <div id="hihi" class="col-md-6 clickClose">
                            <ul class="nav mt-3">
                                ...
                                <li class="nav-item"><a class="nav-link" id="current-main" href="/ContactController">Contact</a></li>
                            </ul>
                        </div>
                        <%
        ...
        <main class="main-close">
            ...
            <div class="container mt-4">
                <div class="row">
                    <div class="col-md-6">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d65643.82403486951!2d105.71553722916656!3d10.033659133706616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31a0629f6de3edb7%3A0x527f09dbfb20b659!2zQ-G6p24gVGjGoSwgTmluaCBLaeG7gXUsIEPhuqduIFRoxqEsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1702488685596!5m2!1svi!2s"
                    ...
                    <div class="col-md-6 contact-detail">
                        ...
                        <div class="">
                            <div class="row home-shop">
                                ...
                                <div class="col-md-6 local-detail">
                                    <h5>600 Nguyen Van Cu Extension</h5>
                                    <p>Open: <strong>Monday - Sunday | 09:00 - 22:00</strong></p>
                                    <p>Phone: <strong>0907626222</strong></p>
                                    <a
                                        href="https://www.google.com/maps/place/FPT+University/@10.0124518,105.7298567,17z/data=!3m1!4b1!4m6!3m5!1s0x31a0882139720a77:0x3916a227d0b95a64!8m2!3d10.0124518!4d105.7324316!16s%2Fg%2F11c6w2mjqm?entry=ttu">Location</a>
                                </div>
                            </div>
                        </div>
                    </div>
