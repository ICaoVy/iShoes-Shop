                        ...
                        <div  class="left-scroll">
                            ...
                            <div class="sport border-title mt-2">
                                ...
                                <ul class="cat-title-show sportUL">
                                    <%
                                        ...
                                        while (rscate1.next()) {
                                    %>
                                    <li><a href="/ProductController?nameCate=<%= rscate1.getString("cate_name") + pathForCate%>"><%= rscate1.getString("cate_name")%></a></li>
                                        <%
                                            }
                                        %>
                                </ul>
                            ...
                            <div class="sandal border-title mt-2">
                                ...
                                <ul class="cat-title-show sandalUL">
                                    <%
                                        ...
                                        while (rscate2.next()) {
                                    %>
                                    <li><a href="/ProductController?nameCate=<%= rscate2.getString("cate_name") + pathForCate%>"><%= rscate2.getString("cate_name")%></a></li>
                                        <%
                                            }
                                        %>
                            ...
                            <div class="shop-by-price border-title mt-2">
                                ...
                                <ul class="cat-title-show dot-1 priceUL">
                                    <li>
                                        <a href="/ProductController?<%= "price=1000000" + pathForPrice%>">
                                            <input type="checkbox" name="priceCheckbox" >
                                            <span>1.000.000vnd <i class="bi bi-arrow-down"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/ProductController?<%= "price=1000000-2000000" + pathForPrice%>">
                                            <input type="checkbox">
                                            <span>1.000.000vnd - 2.000.000vnd</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/ProductController?<%= "price=2000000-5000000" + pathForPrice%>">
                                            <input type="checkbox">
                                            <span>2.000.000vnd - 5.000.000vnd</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/ProductController?<%= "price=5000000" + pathForPrice%>">
                            ...
                            <div class="size border-title mt-2">
                                ...
                                <div class="size-shoes sizeUL">
                                    <a href="/ProductController?<%=  "size=35" + pathForSize%>">35</a>
                                    <a href="/ProductController?<%=  "size=36" + pathForSize%>">36</a>
                                    <a href="/ProductController?<%=  "size=37" + pathForSize%>">37</a>
                                    <a href="/ProductController?<%=  "size=38" + pathForSize%>">38</a>
                                    <a href="/ProductController?<%=  "size=39" + pathForSize%>">39</a>
                                    <a href="/ProductController?<%=  "size=40" + pathForSize%>">40</a>
                                    <a href="/ProductController?<%=  "size=41" + pathForSize%>">41</a>
                                    <a href="/ProductController?<%=  "size=42" + pathForSize%>">42</a>
                                    <a href="/ProductController?<%=  "size=43" + pathForSize%>">43</a>
                                    <a href="/ProductController?<%=  "size=44" + pathForSize%>">44</a>
                                    <a href="/ProductController?<%=  "size=45" + pathForSize%>">45</a>
                            ...
                            <div class="color border-title mt-2">
                                ...
                                <div class="color-manager colourUL">
                                    <a class="text-center" href="/ProductController?<%="colour=Black" + pathForColour%>">
                                        <div style="background-color: black;"><i class="bi bi-check2"></i></div>
                                        <p>Black</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Blue" + pathForColour%>">
                                        <div style="background-color: #40A2D8;"><i class="bi bi-check2"></i></div>
                                        <p>Blue</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Brown" + pathForColour%>">
                                        <div style="background-color: #B99470;"><i class="bi bi-check2"></i></div>
                                        <p>Brown</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Green" + pathForColour%>">
                                        <div style="background-color: #99BC85;"><i class="bi bi-check2"></i></div>
                                        <p>Green</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Grey" + pathForColour%>">
                                        <div style="background-color: #B6BBC4;"><i class="bi bi-check2"></i></div>
                                        <p>Grey</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Multi" + pathForColour%>">
                                        <div style="background: url(./images/multi-colour.jpg)"><i class="bi bi-check2"></i>
                                        </div>
                                        <p>Multi</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Orange" + pathForColour%>">
                                        <div style="background-color: #EA906C;"><i class="bi bi-check2"></i></div>
                                        <p>Orange</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Pink" + pathForColour%>">
                                        <div style="background-color: #E6A4B4;"><i class="bi bi-check2"></i></div>
                                        <p>Pink</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Purple" + pathForColour%>">
                                        <div style="background-color: #756AB6;"><i class="bi bi-check2"></i></div>
                                        <p>Purple</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Red" + pathForColour%>">
                                        <div style="background-color: #DC3535;"><i class="bi bi-check2"></i></div>
                                        <p>Red</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=White" + pathForColour%>">
                                        <div style="background-color: white; border: solid 1px rgb(143, 142, 141);"><i
                                                class="bi bi-check2"></i></div>
                                        <p>White</p>
                                    </a>
                                    <a class="text-center" href="/ProductController?<%=  "colour=Other" + pathForColour%>">
                                ...
                                <div class="col-md-2 text-start mt-1">
                                    <div class="col-md-3">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="/ProductController?sort=High_Low<%=pathJSP%>" class="dropdown-item">Price: Hight-Low</a>
                                            <a href="/ProductController?sort=Low_High<%=pathJSP%>" class="dropdown-item">Price: Low-Hight</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div style="margin-bottom: 300px" class="row mt-3 list-product-right">
                                <%
                                    ...
                                    if (nameCate1 != null && price1 != null && size1 != null && colour1 != null) {
                                        if (price1.equals("1000000")) {
                                            productList = pDAO.getProductByAllSearchPriceLow(nameCate1, Integer.parseInt(size1), colour1, Float.parseFloat(price1));
                                        } else if (price1.contains("-")) {
                                            String s[] = price1.split("-");
                                            productList = pDAO.getProductByAllSearchFromTo(nameCate1, Integer.parseInt(size1), colour1, Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                        } else {
                                            productList = pDAO.getProductByAllSearchPriceHigh(nameCate1, Integer.parseInt(size1), colour1, Float.parseFloat(price1));
                                        }
                                    } else if (nameCate1 != null || price1 != null || size1 != null || colour1 != null) {
                                        if (nameCate1 != null && price1 != null && size1 != null) {
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByAllSearchPriceLow3(nameCate1, Integer.parseInt(size1), Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByAllSearchFromTo3(nameCate1, Integer.parseInt(size1), Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByAllSearchPriceHigh3(nameCate1, Integer.parseInt(size1), Float.parseFloat(price1));
                                            }
                                        } else if (nameCate1 != null && price1 != null && colour1 != null) {
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByAllSearchPriceNoSizeLow3(nameCate1, colour1, Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByAllSearchNoSizeFromTo3(nameCate1, colour1, Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByAllSearchPriceNoSizeHigh3(nameCate1, colour1, Float.parseFloat(price1));
                                            }
                                        } else if (nameCate1 != null && size1 != null && colour1 != null) {
                                            productList = pDAO.getProductByAllSearchNoPrice3(nameCate1, Integer.parseInt(size1), colour1);
                                        } else if (price1 != null && size1 != null && colour1 != null) {
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByAllSearchPriceNoNameLow3(Integer.parseInt(size1), colour1, Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByAllSearchNoNameFromTo(Integer.parseInt(size1), colour1, Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByAllSearchPriceNoNameHigh3(Integer.parseInt(size1), colour1, Float.parseFloat(price1));
                                            }
                                        } else if (nameCate1 != null && price1 != null) {
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByAllSearchNoSizeColorLow2(nameCate1, Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByAllSearchNoSizeColorFromTo2(nameCate1, Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByAllSearchNoSizeColorHigh2(nameCate1, Float.parseFloat(price1));
                                            }
                                        } else if (nameCate1 != null && size1 != null) {
                                            productList = pDAO.getProductByAllSearchNameAndSize2(nameCate1, Integer.parseInt(price1));
                                        } else if (nameCate1 != null && colour1 != null) {
                                            productList = pDAO.getProductByAllSearchNameAndColor2(nameCate1, colour1);
                                        } else if (price1 != null && size1 != null) {
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByAllSearchPriceSizeLow2(Integer.parseInt(size1), Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByAllSearchPriceSizeFromTo2(Integer.parseInt(size1), Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByAllSearchPriceSizeHigh2(Integer.parseInt(size1), Float.parseFloat(price1));
                                            }
                                        } else if (price1 != null && colour1 != null) {
                                            //productList = pDAO.getProductByAllSearchPriceCollor2(Float.parseFloat(price1), colour1);
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByAllSearchPriceColorLow2(colour1, Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByAllSearchPriceColorFromTo2(colour1, Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByAllSearchPriceColorHigh2(colour1, Float.parseFloat(price1));
                                            }
                                        } else if (size1 != null && colour1 != null) {
                                            productList = pDAO.getProductByAllSearchSizeColor(Integer.parseInt(size1), colour1);
                                        } else if (nameCate1 != null) {
                                            productList = pDAO.getProductByCateName(nameCate1);
                                        } else if (price1 != null) {
                                            if (price1.equals("1000000")) {
                                                productList = pDAO.getProductByPriceLow1(Float.parseFloat(price1));
                                            } else if (price1.contains("-")) {
                                                String s[] = price1.split("-");
                                                productList = pDAO.getProductByPriceFromTo2(Float.parseFloat(s[0]), Float.parseFloat(s[1]));
                                            } else {
                                                productList = pDAO.getProductByPriceHigh1(Float.parseFloat(price1));
                                            }
                                        } else if (size1 != null) {
                                            productList = pDAO.getProductBySize(Integer.parseInt(size1));
                                        } else if (colour1 != null) {
                                            productList = pDAO.getProductByColour(colour1);
                                        }
                                    } else {
                                    ...
                                    if (session.getAttribute("search") != null) {
                                        productList = pDAO.getProduceSearchName((String) session.getAttribute("search"));
                                ...
                                <div onmouseenter="ShowOther(event)" onmouseleave="HideOther(event)" class="col-md-4 text-center show-list-pro">
                                    ...
                                    <div class="mt-1 text-start check-other show-list-other">
                                        <%
                                            List<Product> productListChild = pDAO.getProduceCode(pDAO.subString(l.getPro_code()));
