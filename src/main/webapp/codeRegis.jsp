<%-- 
    Document   : forgot
    Created on : Feb 24, 2024, 2:53:54 PM
    Author     : ASUS
--%>
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="text-center">
                        ...
                        <p>The OTP code has been sent to the Email you just registered</p>
                        <form class="form-login" action="SendEmailController" method="post">
                            ...
                            <button name="sendOTP" class="form-control mt-3 button-login" type="submit">Send</button>
                        </form>
                    </div>
                </div>
            </div>
