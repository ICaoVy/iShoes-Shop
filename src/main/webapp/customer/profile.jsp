<%-- 
    Document   : profile
    Created on : Feb 24, 2024, 3:00:10 PM
    Author     : ASUS
--%>
...
<!--                                            <a href="#" class="dropdown-item">...</a>-->
        ...
        <main class="main-close">
            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-md-3">
                        <div class="mt-3"><a href="/ProfileController" style="text-decoration: none; background-color: whitesmoke;color: black" class="profile">Account</a></div>
