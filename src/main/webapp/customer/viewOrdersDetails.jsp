<%-- 
    ...
    Created on : Mar 5, 2024, 7:43:40 AM
    Author     : binht
--%>
                ...
                <div class="order">
                    <div class="head">
                        <table  class="product-table text-center">
                            ...
                            <tbody >
                                <c:forEach items="${oDetail}" var="o" >
                                    <tr >
                                        <td>${o.order_id}</td>
                                        <td>${o.order_fullname}</td>
                                        <td>${o.pro_name}</td>
                                        <td>${o.order_email}</td>
                                        <td>${o.order_phone}</td>
                                        <td>${o.order_address}</td>
                                        <td>${o.detail_quantity}</td>
                                        <td>${o.detail_price}</td>
                                        <td>${o.detail_size}</td>
                                        <td>${o.detail_colour}</td>
                                        <td>${o.order_note}</td>
                                        <td><img style="width: 100%" src="/images/${o.pro_picture}" alt="alt"/></td>
                                        <td><c:choose>
                                                <c:when test="${o.order_status == 0}">
                                                    Processing
                                                </c:when>
                                                <c:otherwise>
                                                    Approved
                                        ...
                                        <td>
                                            <c:if test="${o.order_status == 0}">
                                                <a style="border-radius: 30px" class="btn btn-success" href="/OrderController/Ordered/editinfo/${o.order_id}">Edit</a>
                                            </c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
