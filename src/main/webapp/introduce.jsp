<%-- 
    Document   : introduce
    Created on : Feb 24, 2024, 2:44:34 PM
    Author     : ASUS
--%>
...
<!--                                            <a href="#" class="dropdown-item">...</a>-->
        ...
        <main class="main-close mt-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <h2>ICAFY - Style, Confidence, Uniqueness</h2>
                        <p>Chào mừng đến với ICAFY - nơi thăng hoa phong cách và tự tin của bạn! Tại ICAFY, chúng tôi không
                            chỉ là một cửa hàng quần áo, mà là ngôi nhà của sự độc đáo và cái đẹp riêng biệt. Với sứ mệnh
                            làm cho mỗi khoảnh khắc của bạn trở nên đặc biệt, chúng tôi tự hào mang đến cho khách hàng những
                            bộ trang phục chất lượng cao, từ thiết kế độc quyền đến những xu hướng thời trang hàng đầu.</p>
                        <p>Tại ICAFY, chúng tôi không chỉ chú trọng đến việc tạo ra những sản phẩm thời trang xuất sắc, mà
                            còn đặt biệt quan tâm đến trải nghiệm mua sắm của bạn. Với dịch vụ chăm sóc khách hàng tận tâm
                            và không ngừng nỗ lực cải tiến, chúng tôi cam kết làm cho mỗi lần ghé thăm ICAFY trở thành một
                            chuyến phiêu lưu thú vị trong thế giới thời trang.</p>
                        <p>Hãy đồng hành cùng ICAFY, nơi những ý tưởng sáng tạo gặp gỡ với phong cách cá nhân của bạn. Chúng
                            tôi tin rằng, từng chiếc áo và mỗi chiếc quần tại ICAFY không chỉ là trang phục, mà là cách bạn
                            diễn đạt chính mình. Hãy để ICAFY là nguồn cảm hứng cho hành trình thời trang của bạn!</p>
                    </div>
                    <div class="col-md-3 category">
                        <h3><strong>Category</strong></h3>
                        <a href="#">ICAFY | PRODUCT</a>
                        <br>
                        <a href="#">ICAFY | ABOUT US</a>
                        <br>
                        <a href="#">ICAFY | CONTACT</a>
                        <img class="img-fluid" src="./images/3699445.jpg" alt="">
                    </div>
                </div>
            </div>
